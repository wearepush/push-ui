...
describe('FormFieldError', () => {
  it('should render with initial state', () => {
    const error = shallow(<FormFieldError text="Message with error" />);
  ...
  it('should render with warning', () => {
    const error = shallow(<FormFieldError text="Message with error" type="error" />);
    expect(error.hasClass('is-error')).toBe(true);
  });

  it('should render with warning', () => {
    const error = shallow(<FormFieldError text="Message with error" type="warning" />);
