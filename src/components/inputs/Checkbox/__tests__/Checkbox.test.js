...
import { CheckboxComponent as Checkbox } from "../Checkbox.js";
...
describe("Checkbox", () => {
  describe("default props", () => {
    ...
    it("should render with className prop", () => {
      ...
      const _checkbox = checkbox.find(".Checkbox__checkbox");
      const icon = checkbox.find(".Checkbox__icon");
      const input = checkbox.find(".Checkbox__input");
      const label = checkbox.find(".Checkbox__label");

      expect(_checkbox.hasClass("Checkbox__checkbox_test")).toBe(true);
