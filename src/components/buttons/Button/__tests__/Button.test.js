...
describe('Button', () => {
  describe('default props', () => {
    ...
    it('should render href prop', () => {
      const button = shallow(
        <Button component="a" href="http://example.com">
          Button
        </Button>
      );
    ...
    it('should render with name prop', () => {
      const button = shallow(<Button name="name">Button</Button>);
      expect(button.prop('name')).toEqual('name');
    });

    it('should render with className prop', () => {
      const button = shallow(<Button className="test">Button</Button>);
    ...
    it('should render custom prop', () => {
      const button = shallow(<Button data-test="test">Button</Button>);
